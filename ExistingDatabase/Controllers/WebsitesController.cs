...
namespace ExistingDatabase.Controllers
{
    public class WebsitesController : Controller
    {
        ...
        {
            var query = "Select * from Website Where Rank = 1";
            IEnumerable<Website> data = db.Database.SqlQuery<Website>(query);
        ...
        public ActionResult Create([Bind(Include = "Id,WebsiteName,Description,Rank,Country")] Website website)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,WebsiteName,Description,Rank,Country")] Website website)
        {
            if (ModelState.IsValid)
            {
